export const questions = [
  ...
  "Which companies had R&D growth outpacing revenue growth for 4 consecutive quarters?",
  "Which semiconductor stocks have EV/EBITDA under 10 and debt-to-equity ratio under 0.5?",
  "Which companies had the highest inventory turnover last fiscal year?",
  "Which stocks have inventory changes that are negatively correlated with cash changes?",
  ...
  "Which stocks bought back more than 5% of their market cap in the past 12 months?",
  ...
  "Which companies had >50% of other income from non-operating sources?",
  "Which companies had negative working capital ratios for 4 straight quarters?",
  "Which companies had >50% of assets as intangible but still >15% net income margins?",
  "Which industries had the strongest correlation between D&A and EBITDA margin?",
  "Which manufacturing firms had the highest capex-to-depreciation ratio over 5 years?",
  "Which companies had >20% YoY growth in deferred revenue and rising EPS?",
  "Which companies had FX translation effects over 10% of net income?",
  ...
  "Which companies increased net borrowing by >20% and saw rising interest expense?",
  "Which companies have the highest preferred stock to permanent equity ratio?",
  "Which companies have high deferred asset charges affecting income before tax?",
  "Which stocks have the widest normalized spread between 200 and 50 day MAs?",
  "Which companies grew permanent equity the fastest over 3 years and saw price rise?",
  "Which companies had consistently negative investing cash flows but positive financing cash flows?",
];
